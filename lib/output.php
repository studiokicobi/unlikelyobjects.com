...
add_action( 'wp_enqueue_scripts', 'uo-custom_css' );
/**
...
function uo-custom_css() {
	...
	if ( $logo ) {
		...
		$logo_max_width        = get_theme_mod( 'uo-custom_logo_width', 350 );
	...
	$css .= ( uo-custom_customizer_get_default_link_color() !== $color_link ) ? sprintf(
		'
	...
	$css .= ( uo-custom_customizer_get_default_accent_color() !== $color_accent ) ? sprintf(
		'
